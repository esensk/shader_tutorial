...
const gl = canvas.getContext("webgl") || canvas.getContext("exprimental-webgl") as WebGLRenderingContext
...
const func = () => {
    ...
    mat.rotate(mMatrix, rad1, [0, -1.0, 0.0], mMatrix)
    mat.multiply(tmpMatrix, mMatrix, mvpMatrix)
    gl.uniformMatrix4fv(uniLocation[0], false, mMatrix)
    gl.uniformMatrix4fv(uniLocation[1], false, mvpMatrix)
    ...
    mat.translate(mMatrix, [5.0, 0.0, 0.0], mMatrix)
    mat.rotate(mMatrix, rad1, [1, -1, 1], mMatrix);
    mat.multiply(tmpMatrix, mMatrix, mvpMatrix)
    gl.uniformMatrix4fv(uniLocation[0], false, mMatrix)
    gl.uniformMatrix4fv(uniLocation[1], false, mvpMatrix)
    gl.uniform1i(uniLocation[5], 1)
